...
public final class IntentionsDescriptor extends IntentionAspectBase {
  ...
  public IntentionsDescriptor() {
    ...
    myId2Index[0] = 0x2c5a37ebd022d527L;
    myId2Index[1] = 0x2c5a37ebd022d54bL;
  }
    ...
    switch (index) {
      case 0:
        ...
        if (myIntentions0 == null) {
          ...
          myIntentions0[0] = new intention_create_DijagramKonteksta_Intention();
        }
        return Arrays.asList(myIntentions0);
      case 1:
        // Concept: DijagramKonteksta 
        if (myIntentions1 == null) {
          myIntentions1 = new IntentionFactory[1];
          myIntentions1[0] = new intention_remove_DijagramKonteksta_Intention();
        }
  ...
  public Collection<IntentionFactory> getAllIntentions() {
    ...
    rv[0] = new intention_create_DijagramKonteksta_Intention();
    rv[1] = new intention_remove_DijagramKonteksta_Intention();
